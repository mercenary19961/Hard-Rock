        ...
        <section id="why-hardrock" className="relative pt-15 pb-10 md:pb-20 md:pt-20 lg:pb-64 overflow-hidden bg-white dark:bg-black">
            ...
            <div className="relative z-10 w-full px-8 sm:px-12 lg:px-16 xl:px-20">
                <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center">
                    ...
                    >
                        <h2 className={`text-4xl xs:text-5xl sm:text-5xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-black mb-8 ${isArabic ? 'font-tajawal' : 'font-sf-pro'}`} style={isArabic ? {
                            lineHeight: '2',
                            paddingTop: '0.5em',
                            paddingBottom: '0.3em',
                            overflow: 'visible',
